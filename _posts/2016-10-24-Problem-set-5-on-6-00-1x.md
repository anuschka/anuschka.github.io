---
layout: post
title:  Problem set 5 courtesy of MIT
tags:
- Blog
- Post
---

In this problem set, I implemented a version of an encryption algorithm and played with object!
...
To run this file I needed words.txt and story.txt in the same directory.
...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        self.message_text_encrpyted = self.apply_shift(shift)
    ...
    def get_message_text_encrypted(self):
       ...
       '''
        return self.message_text_encrpyted
...
text = Message("th!s is Problem Set 6?")
print(text.apply_shift(5))

plaintext = PlaintextMessage('1.hello!!', 5)
shifted_text =  plaintext.get_message_text()
