---
layout: post
title:  Problem set 4 courtesy of MIT: 6.00.1x
tags:
- Blog
- Post
---
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    newhand = hand.copy()
    itters = calculateHandlen(newhand)
    score = 0
    ...
    while calculateHandlen(newhand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(Input, newhand, wordList) == False:
            ...
            # Otherwise (the word is valid):
                ...
                curWordScore = getWordScore(Input, n)
                score += curWordScore
                print('"' + str(Input) + '" earned ' + str(curWordScore) + ' points. Total: ' + str(score))
                print
                # Update theie hand
                newhand = updateHand(newhand, Input)
